...
<link href="{{ URL::asset('http://fonts.googleapis.com/css?family=Source+Sans+Pro:200,300,400,600,700,900|Quicksand:400,700|Questrial') }}" rel="stylesheet" />
...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo"> 
			<h1><a href="#">Dare To Challenge</a></h1>
			<div id="menu">
				<ul>
